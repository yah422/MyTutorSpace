 ...
 */
final class Version20241028205917 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lecon ADD user_id INT NOT NULL, ADD date_creation DATETIME NOT NULL, ADD description VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lecon DROP user_id, DROP date_creation, DROP description');
    }
}
