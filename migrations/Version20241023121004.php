 ...
 */
final class Version20241023121004 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lecon ADD CONSTRAINT FK_94E6242E82350831 FOREIGN KEY (matieres_id) REFERENCES matiere (id)');
