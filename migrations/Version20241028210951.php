 ...
 */
final class Version20241028210951 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lecon ADD matiere_id INT NOT NULL, ADD user_id INT NOT NULL, ADD description VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lecon DROP matiere_id, DROP user_id, DROP description');
    }
}
