 ...
 */
final class Version20241028212359 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lecon DROP date_creation');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lecon ADD date_creation DATETIME DEFAULT CURRENT_TIMESTAMP');
    }
}
